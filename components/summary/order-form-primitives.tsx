    ...
    <label className={cn("flex min-w-0 items-baseline gap-1", className)}>
      ...
      {onChange ? (
        <input
          ...
          className="min-w-0 flex-1 border-b border-surf-black bg-transparent font-bold text-surf-black outline-none placeholder:font-normal placeholder:text-surf-muted/60 focus:border-surf-accent-blue order-form-value"
        />
      ) : (
