 ...
 * editor, the rail band calculator, the volume estimator and the fin placement screen without
 * editing the URL. Client component because it reads the active path (usePathname) to highlight
 * the current link.
 */
