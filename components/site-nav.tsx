...
export function SiteNav() {
  ...
  return (
    ...
    >
      <Link
        href="/"
        className="text-sm font-extrabold tracking-architectural text-surf-black transition-colors hover:text-surf-accent-blue"
      >
        SHAPER
      </Link>
          ...
          return (
            <Link
              ...
              className={
                ...
                (active
                  ? "border-surf-accent-blue text-surf-black"
