...
| clerk | OPT-OUT | Pre-existing from Phase 2, untouched here — appears only as a placeholder CI env value so `next build` passes without a key. No Clerk capability added, removed or wired. |
