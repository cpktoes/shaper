...
| ROCKER | up to 45dvh | The side profile is a flat, wide curve — needs width, not height |
...
| populated | Rocker drawing + readout (media, control, text) | ✅ covered | The flat side profile with its rocker rails and callouts, the four handles with their chords and knot dots, in the pinned area at up to 45dvh; nose-up in portrait and flat in landscape (D-09). |
