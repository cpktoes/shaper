...
Stopped at: Template viewer rotation shipped and verified in the browser — +11% board length, drag correct in both orientations (50px moves 6.4in vertical / 5.7in horizontal, matching the measured scales), Summary and print untouched. Open: a further ~+9% is available by clamping the extreme-station chips inward and re-proportioning the rotated rails (sketch 005 shrank its gutters 176->140 for the same reason). Not pushed.
Resume file: None
