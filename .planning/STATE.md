...
Stopped at: Every .css swept for un-themeable literals; only @media print ones remain. Open: dropping the slider stroke needs `well` separated from `sidebar` first (1.00-1.37:1 today). ~43 commits unpushed. Units toggle still deferred
Resume file: None
