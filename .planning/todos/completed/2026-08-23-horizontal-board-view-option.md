...
Shipped before Phase 3 planning: the rotate-in-place orientation switch per sketch 006 lives in
`components/outline/outline-editor.tsx` / `outline-viewer.tsx`. Confirmed by the user during the
Phase 3 discussion (2026-08-28): "horizontal board view already implemented."
