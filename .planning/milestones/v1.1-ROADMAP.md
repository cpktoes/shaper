...
- ~~No SECURITY.md for phases 5 and 7.~~ Phase 5 resolved 2026-09-06 by a retroactive pass —
  30/30 threats closed, 0 open. Phase 7 still has none; it is display-only work that added no input
  path, no network call and no database access.
